...
export default function Page() {
  const { formData: subscribeFormData, handleInputChange: subscribeHandleInputChange, handleSubmit: subscribeHandleSubmit } = useEmailSubscribeForm();
              ...
              <div className="row">
                <div className="col-lg-4">
                  <div className="heading2 mr50">
                    ...
                    <p>
                      Have questions about your tax filings or need assistance
                      with tax planning? We’re here to help! Reach out to us,
                      and our experts will guide you through the process,
                      ensuring you get the maximum refund.
                    </p>
                  </div>
                </div>
                      ...
                      <div className="row">
                        ...
                        <div className="col-12">
                          <textarea
                            ...
                            cols={30}
                            rows={5}
                            placeholder="Let us know your tax-related question"
              ...
              <div className="row">
                ...
                <div className="col-lg-4 col-md-6">
                  <div className="single-office">
                    ...
                    <p>
                      No:11, 2nd floor, 80 feet road, Koramangala 1st block, 80
                      ft road, Bangalore 560034
                    </p>
                    <Link
                ...
                <div className="col-lg-4 col-md-6">
                  <div className="single-office">
                    ...
                    <p>
                      Plot No: 684, Obulreddy Complex, Vivekanandha Nagar,
              ...
              <div className="row">
                <div className="col-lg-6">
                  <div className="single-faq2">
                    ...
                    <p>
                      We offer a wide range of tax services, including Federal &
                      State tax filings, ITIN preparation, tax representation,
                      advanced tax planning, FBAR and FATCA compliance,
                      amendment filing, and Indian tax filings.
                    </p>
                  </div>
                  <div className="single-faq2">
                    <h3>How can EvoTax help me maximize my tax refund?</h3>
                    <p>
                      Our team carefully reviews your financial situation to
                      identify all possible deductions and credits, ensuring you
                      get the maximum refund. We stay up-to-date on the latest
                      tax laws to optimize your tax filings.
                    </p>
                  </div>
                  <div className="single-faq2">
                    <h3>Do you offer tax services for businesses?</h3>
                    <p>
                      Yes, we offer comprehensive tax services for businesses,
                      including payroll tax management, business tax filings,
                      and advanced tax planning to minimize liabilities and
                      ensure compliance with tax regulations.
                    </p>
                  </div>
                  <div className="single-faq2">
                    <h3>
                      Can EvoTax assist with tax filings for both U.S. and
                      Indian taxes?
                    </h3>
                    <p>
                      Yes! We specialize in handling both U.S. and Indian tax
                      filings. Our team is well-versed in the tax laws of both
                      countries and ensures compliance with both systems while
                ...
                <div className="col-lg-6">
                  <div className="single-faq2">
                    ...
                    <p>
                      ...
                      required for individuals who are not eligible for a Social
                      Security Number but need to file a tax return in the U.S.
                      EvoTax helps you with the application process and ensures
                      it’s done correctly.
                    </p>
                  </div>
                  <div className="single-faq2">
                    ...
                    <p>
                      If you discover an error or omission on your original tax
                      return after it’s filed, you may need to amend it. EvoTax
                      can assist you in reviewing your return and filing the
                      necessary amendments to correct any mistakes.
                    </p>
                  </div>
                  <div className="single-faq2">
                    <h3>
                      What is the deadline for filing U.S. taxes, and how can
                      EvoTax help?
                    </h3>
                    <p>
                      The deadline for filing U.S. taxes is typically April
                      15th, but extensions are available. EvoTax helps you meet
                      the deadline and can file for an extension if necessary,
                      ensuring timely and accurate filings.
                    </p>
                  </div>
                  <div className="single-faq2">
                    <h3>
                      How does EvoTax assist with FBAR and FATCA compliance?
                    </h3>
                    <p>
                      We offer specialized services to help U.S. taxpayers with
                      foreign accounts comply with FBAR (Foreign Bank Account
                      Reporting) and FATCA (Foreign Account Tax Compliance Act).
                      Our team ensures that all required forms are filed
                ...
                <div className="row align-items-center">
                  <div className="col-md-6">
                    <div className="heading4 inner-heading no-margin-heading">
                      ...
                      <p>
                        If you're a business with complex tax needs or high
                        payment volumes, reach out to discuss customized tax
                        solutions and pricing options tailored to your specific
                        requirements.
                      </p>
                    </div>
                  </div>
                  <div className="col-md-6 text-md-right">
                    <Link href="#Contact2" className="theme-btn-11">
                      Get In Touch
                    </Link>
                  </div>
                </div>
                ...
                <div className="col-lg-5 col-md-6 offset-lg-1">
                  <div className="sunscribe-form">
                    <div className="subscribe-from-wrap">
                      <form onSubmit={subscribeHandleSubmit}>
                      <input type="email" name='email' value={subscribeFormData.email} placeholder="Email Address"  onChange={subscribeHandleInputChange} required />
