        ...
        <div>
          ...
          <div className="container padding-90">
            <table className="w-100">
              ...
              <tr>
                <td>SCHEDULE C,E & 1099MISC</td>
                <td>$119.99</td>
              </tr>
              <tr>
                <td>FBAR FILING/FATCA FILING</td>
                <td>$29.99</td>
              </tr>
              <tr>
                <td>STATE RENTAL CREDIT & OSTC CREDIT PLANNING</td>
                <td>$19.99</td>
              </tr>
              <tr>
              ...
              <tr>
                <td>STOCK TRANSACTION(PER PAGE)</td>
                <td>$10.00</td>
              </tr>
              <tr>
              ...
              <tr>
                <td>OPTIMIZED TAX PLANNING CHARGES</td>
                <td>$150.00</td>
              </tr>
              <tr>
                <td>UNLIMITED TAX REPRESENTATION FOR 8 SUCCESSIVE YEARS</td>
                <td>Free</td>
              </tr>
            </table>
          </div>
