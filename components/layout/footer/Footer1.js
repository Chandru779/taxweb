                        ...
                        <div className="col-lg col-md-6">
                            <div className="single-footer">
                                ...
                                <div className="footer-menu">
                                    <ul>
                                        <li><Link href="/service-2">Federal & State Filing</Link></li>
                                        <li><Link href="/service-2">Tax Representation</Link></li>
                                        <li><Link href="/service-2">ITIN Preparation</Link></li>
                                        <li><Link href="/service-2">Advanced Tax Planning</Link></li>
                                        <li><Link href="/service-2">FBAR & FATCA Compliance</Link></li>
                                        <li><Link href="/service-2">Amendment Filing</Link></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
