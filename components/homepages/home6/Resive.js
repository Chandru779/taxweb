                    ...
                    <div className="row align-items-center">
                        <div className="col-lg-6">
                            <div className="hadding6 tesive6-hadding">
                                ...
                                <p className="font-f-7" data-aos="fade-right" data-aos-duration={900}>At EvoTax, our expert team is committed to helping you maximize your tax benefits. From accurate Federal & State Filing to expert Tax Representation and Advanced Tax Planning, we ensure you keep more of what you've earned while staying fully compliant with tax regulations.</p>
